          ...
          child: Column(
            ...
            children: [
              _buildSection(
                ...
                title: 'مقدمة',
                content:
                    'مرحباً بك في تطبيق AdenTweet ("الخدمة") الذي تديره مؤسسة QTBM ("نحن"، "لنا"، "إلينا"). تحكم شروط الاستخدام هذه ("الشروط") استخدامك للتطبيق والخدمات المرتبطة به. باستخدامك للخدمة، فإنك توافق على الالتزام بهذه الشروط.',
              ...
              _buildSection(
                ...
                content:
                    'بإنشائك حساباً أو استخدامك لتطبيق AdenTweet، فإنك توافق على الالتزام بهذه الشروط بالكامل. إذا كنت لا توافق على أي جزء من هذه الشروط، يجب عليك عدم استخدام الخدمة. نحتفظ بالحق في تعديل هذه الشروط في أي وقت، وسيتم إخطارك بأي تغييرات جوهرية.',
                textPrimary: textPrimary,
                textSecondary: textSecondary,
              ),
              _buildSection(
